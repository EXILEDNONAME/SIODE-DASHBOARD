...
<div class="table-responsive">
  <table width="100%" class="table table-stiped table-bordered">
    <tr>
      ...
      <td class="align-middle"> {{ \Carbon\Carbon::parse($order->date_start)->format('d F Y, H:i') }} </td>
    </tr>
    <tr>
      <td class="align-middle font-weight-bold"> Date End </td>
      <td class="align-middle"> {{ \Carbon\Carbon::parse($order->date_end)->format('d F Y, H:i') }} </td>
    </tr>
    <tr>
