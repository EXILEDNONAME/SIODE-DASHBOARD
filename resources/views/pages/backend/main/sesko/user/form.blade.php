<div class="kt-section__body">
  ...
  <div class="form-group row">
    <label class="col-lg-3 col-form-label"> Code Customer </label>
    <div class="col-lg-9">
      {!! Form::text('code_customer', (isset($data->code_customer) ? $data->code_customer : ''), ['class' => $errors->has('code_customer') ? 'form-control is-invalid' : 'form-control', 'required' => 'required']) !!}
      @error('code_customer') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
    </div>
  </div>
